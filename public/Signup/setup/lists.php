...
?>
		...
		echo '<tr><th><label for="chk_'.$k.'">'.$item['title'].'</label></th><td class="checkbox"><input type="checkbox" '.$checked . $disabled .' class="checkbox" name="lists[]" value="'.$item['title'].'" id="chk_'.$k.'" /></td></tr>';
		}
